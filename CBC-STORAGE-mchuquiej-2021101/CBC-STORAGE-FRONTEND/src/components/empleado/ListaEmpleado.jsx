...
import '../empleado/EmpleadoStyle4.css';
...
export const TodoListFormEmpleado = () => {
    ...
    return (
        <div className="contenedorPrincipalE">
            <h2 className="tituloEmpleado">EMPLEADOS</h2>
            <form onSubmit={handleAddEmpleado} className="contenedorEmpleado">
                <div className="row">
                    {/*--- PRIMERA COLUMNA ---*/}
                ...
                {/*---Div para separacion con la tabla ---*/}
                <div className="espacioAbajo"></div>

                {/*--- Inicio de los botones ---*/}
                <div className="contenedorBotonesE">
                    <button className="botonUnoE" type="submit" disabled={isSubmitButtonDisabled}>
                        {editingEmpleadoId ? 'ACTUALIZAR' : 'AGREGAR'}
                    </button>

                    <button className="botonDosE" type="button" onClick={cancel}>
                        CANCELAR
                    </button>
                </div>
            </form>
